           ...
           <?php if(@$contacts['name'] !='' || @$contacts['secondname'] !=''):  ?>
            <div class="row mb-15">
                ...
                <div class="col-6 info">
                    <p><?=$contacts['name']?> <?=$contacts['secondname']?></p>
                </div>
            </div>
            <?php endif ?>
           ...
           <?php if(@$contacts['email'] !='') { ?>
            <div class="row mb-15">
                ...
                <div class="col-6 link-box-info">
                    <p><a class="link" href="mailto:<?=$contacts['email']?>"><?=$contacts['email']?></a></p>
                </div>
            </div>
            <?php } ?>
          ...
          <?php endif ?>
           ...
           <?php if(@$contacts['phone'] !='') { ?>
            <div class="row mb-15">
                ...
                <div class="col-6 info">
                    <p><a class="link" href="tel:<?=$contacts['phone']?>"><?=$contacts['phone']?></a></p>
                </div>
            </div>
            <?php } ?>
