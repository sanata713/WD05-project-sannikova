            ...
            <div class="col-10 offset-1">
                ...
                <div class="user-profile-comments">
                    <div class="user-comment">
                        <div class="user-comment-profile">
                            <a class="mr-20" href="#!" target="_blank">
                                <span class="user-comment__article-title">Поездка в LA</span>
                            </a>
                            <span class="user-comment__date"><i class="far fa-clock icon--mr"></i>05 Мая 2017 года в 15:45</span>
                    ...
                    <div class="user-comment">
                        <div class="user-comment-profile">
                            <a class="mr-20" href="#!" target="_blank">
                                <span class="user-comment__article-title">Ноутбук для веб-разработчика</span>
                            </a>
                            <span class="user-comment__date"><i class="far fa-clock icon--mr"></i>15 Мая 2017 года в 10:02</span>
                            <div class="user-comment__text-profile">
                                <p>Замечательный парк, обязательно отправлюсь туда этим летом. </p>
                            </div>
                        </div>
                    ...
                    <div class="user-comment">
                        <div class="user-comment-profile">
                            <a class="mr-20" href="#!" target="_blank">
                                <span class="user-comment__article-title">Настройка Sublime</span>
                            </a>
                            <span class="user-comment__date"><i class="far fa-clock icon--mr"></i>12 Мая 2017 года в 20:39</span>
                            <div class="user-comment__text-profile">
                                <p>Замечательный парк, обязательно отправлюсь туда этим летом. </p>
                            </div>
                        </div>
