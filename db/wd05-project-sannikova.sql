...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 19 2019 г., 16:27
...
(28, 'Test 22', '8', '<p>Бали &ndash; достаточно продвинутое для юго-восточной азии место. Здесь есть больницы международного уровня, их достаточно много. Там все оборудовано по международным меркам, есть современная аппаратура, чисто и аккуратно (как положено в приличных больницах), врачи говорят на английском языке, приятное обслуживание и вас буквально носят на руках.</p>\r\n\r\n<p>Все это звучит обнадеживающе, но есть два минуса. Во-первых, здесь очень дорогие медицинское обслуживание. Каждый раз попадая в популярную на Бали клинику BIMC чувствуешь себя как в у официального автодилера: все вроде бы дорого и красиво, но есть ощущение, что постоянно назначают все возможные процедуры, лишь бы содрать побольше денег. И без медицинского страхового полиса можно просто разориться. (Простой осмотр врача в таких клиниках обходится минимум в 100 долларов.)</p>\r\n\r\n<p>Про качество медицины спорить на стану (я же не врач), но лично у меня есть обоснованное подозрение, что несмотря на современность оборудования клиник, не стоит обольщаться уровнем местных врачей. То есть что-то простое сделают без проблем, если что-то сложное и загадочное (особенно уровня ума доктора Хауса :) то лучше не слишком надеяться на компетентность местных врачей). Увы.</p>\r\n\r\n<p>Про дорогое обслуживание замечу отдельно. 100$ за прием &ndash; это конечно же цены международных больниц типа BIMC или Kasih Ibu. Есть более дешевые варианты: городские государственные больницы вроде Sanglah Hospital и частные практикующие врачи. Но тут как с российскими клиниками, будьте готовы столкнуться со столетним оборудованием или не слишком стерильными помещениями. Если вам это &ldquo;ок&rdquo;, то вы спасены, если нет, то бегите делать страховку :)</p>\r\n\r\n<p>Но вообще совет от БалиБлоггер для всех один &ndash; как туристов, так и проживающих здесь &ndash; лучше сделать страховку, чтобы обезопасить себя от чрезмерных затрат на медицину. Кстати, для серферов и любителей других экстремальных видов спорта, нужна спортивная страховка.</p>\r\n', 1, '2019-02-17 12:37:01', NULL, NULL, '2019-02-19 16:07:33'),
